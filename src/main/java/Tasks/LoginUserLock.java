...
public class LoginUserLock implements Task {
    private List<User> listUser;

    public LoginUserLock(List<User> listUser) {
    ...
    public static LoginUserLock inThePage(List<User> listUser) {
        return new LoginUserLock(listUser);
    }
}
