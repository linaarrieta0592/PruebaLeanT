...
public class HighestPrice implements Task {
    private List<User> listUser;

    public HighestPrice(List<User> listUser) {
    ...
    public static HighestPrice thatUserPurchase(List<User> listUser) {
        return new HighestPrice(listUser);
